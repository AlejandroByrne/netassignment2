    ...
    try:
        ...
        while (True):
            ...
            if (digest_type == 'digest'):
                ...
                dmac_table_entry = p4info_helper.buildTableEntry("MyIngress.dmac_table", match_fields={"hdr.ethernet.dstAddr": eth_src_addr}, action_name="forward_to_port", action_params={"egress_port": port_id})
